...
class OthersNotification extends Model
{
    protected $connection= 'module0';

    protected $table = 'OTHERS_NOTIFICATION';

    protected $primaryKey = 'OTHERS_NOTIFICATION_ID';
