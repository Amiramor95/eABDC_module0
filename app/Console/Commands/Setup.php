...
class Setup extends Command
{
    ...
    public function handle()
    {
        ...
        if ($this->confirm('Please ensure you already configured Keycloak before performing this request. Do you wish to continue?')) {
            ...
            $dbIP = $this->anticipate('Please enter the IP for DB Server', ['192.168.2.67']);
            ...
            $setting = KeycloakSettings::where('KEYCLOAK_CLIENT_ID', 'reg-client')->first();
            ...
            $updatePublic = KeycloakSettings::where('KEYCLOAK_CLIENT_ID', 'reg-client')->first();
