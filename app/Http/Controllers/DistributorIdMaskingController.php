...
use App\Models\DistributorIdMasking;
...
class DistributorIdMaskingController extends Controller
{
    public function get(Request $request)
    {
        try {
            $data = DistributorIdMasking::find($request->DISTRIBUTOR_MASKING_ID);
    ...
    public function getAll(Request $request)
    {
        try {
            ...
            $data = DistributorIdMasking::orderBy('DISTRIBUTOR_MASKING_ID','desc')->get();
    ...
    public function getLatest(Request $request)
    {
        try {
            ...
            //  DistributorIdMasking::orderBy('DISTRIBUTOR_MASKING_ID', 'DESC')->first();
    ...
    public function create(Request $request)
    {
        ...
        try {
            ...
            //create function
            $idmasking = DistributorIdMasking::where('RUN_NO', $request->RUN_NO)->first();
            if(!$idmasking)
            {
                $update=DB::table('admin_management.DISTRIBUTOR_ID_MASKING_SETTING as DISTRIBUTOR_ID_MASKING_SETTING')->update(['DISTRIBUTOR_ID_MASKING_SETTING.STATUS' => 'INACTIVE']);

                $data = new DistributorIdMasking;
