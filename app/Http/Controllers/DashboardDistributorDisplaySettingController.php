...
class DashboardDistributorDisplaySettingController extends Controller
{
    public function get(Request $request)
    {
        try{
            ...
            $data_distributor = DashboardDistributorDisplaySetting::where('SETTING_USER_TYPE',$request->SETTING_USER_TYPE)//->where('ACCESS_USER_DEPARTMENT',$request->ACCESS_USER_DEPARTMENT)
            ->where('ACCESS_USER_DIVISION',$request->ACCESS_USER_DIVISION)
             ...
             //->where('SETTING_USER_GROUP',$request->SETTING_USER_GROUP)
            ->first();
            if($data_distributor){
               // Log::info( "User ID ===>" . $request->SETTING_USER_TYPE);
                if($request->SETTING_USER_TYPE == 'fimm')
                {
                    Log::info( "User ID ===>" . $request->SETTING_USER_TYPE);

                   
                // $data= DB::table('admin_management.DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING AS DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING')
                // ->select('DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.SETTING_USER_TYPE AS SETTING_USER_TYPE','DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.DISPLAY_SETTING_ID AS DISPLAY_SETTING_ID','DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.SETTING_CHART_ID AS SETTING_CHART_ID','DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.SETTING_INDEX AS SETTING_INDEX','DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.SETTING_STATUS AS SETTING_STATUS','DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.DISPLAY_SETTING_STYLE AS DISPLAY_SETTING_STYLE','DASHBOARD_CHART_TYPE.CHART_NAME','DASHBOARd_MAIN_SETTING.DASHBOARD_LIST','DASHBOARd_MAIN_SETTING.DASHBOARD_DESCRIPTION','DASHBOARd_MAIN_SETTING.GRAPH_ID')
                // ->leftJoin('admin_management.DASHBOARD_CHART_TYPE AS DASHBOARD_CHART_TYPE', 'DASHBOARD_CHART_TYPE.CHART_ID', '=', 'DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.SETTING_CHART_ID')
                // ->leftJoin('admin_management.DASHBOARd_MAIN_SETTING AS DASHBOARd_MAIN_SETTING', 'DASHBOARd_MAIN_SETTING.DASHBOARD_MAIN_ID', '=', 'DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.DASHBOARD_SETTING_ID')
                // ->where('DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.SETTING_USER_TYPE','=','fimm')
                // ->where(function($query) {
                //     $query->where('DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.ACCESS_USER_DEPARTMENT', '=' , 1)
                //     ->orWhere('DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.SUPER_USER_DEPARTMENT', '=' , 7);
                // })
                // ->orderBy('SETTING_INDEX', 'asc')
                // ->get();
                $data= DB::table('admin_management.DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING AS DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING')
                ->select('DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.SETTING_USER_TYPE AS SETTING_USER_TYPE','DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.DISPLAY_SETTING_ID AS DISPLAY_SETTING_ID','DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.SETTING_CHART_ID AS SETTING_CHART_ID','DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.SETTING_INDEX AS SETTING_INDEX','DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.SETTING_STATUS AS SETTING_STATUS','DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.DISPLAY_SETTING_STYLE AS DISPLAY_SETTING_STYLE','DASHBOARD_CHART_TYPE.CHART_NAME','DASHBOARd_MAIN_SETTING.DASHBOARD_LIST','DASHBOARd_MAIN_SETTING.DASHBOARD_DESCRIPTION','DASHBOARd_MAIN_SETTING.GRAPH_ID')
                ->leftJoin('admin_management.DASHBOARD_CHART_TYPE AS DASHBOARD_CHART_TYPE', 'DASHBOARD_CHART_TYPE.CHART_ID', '=', 'DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.SETTING_CHART_ID')
                ...
                ->where('DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.SETTING_USER_GROUP', '=' , 2)
                ->orderBy('SETTING_INDEX', 'asc')
                ->get();
                }
                else
                {
                    ...
                    // ->leftJoin('admin_management.DASHBOARD_CHART_TYPE AS DASHBOARD_CHART_TYPE', 'DASHBOARD_CHART_TYPE.CHART_ID', '=', 'DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.SETTING_CHART_ID')
                    // ->leftJoin('admin_management.DASHBOARd_MAIN_SETTING AS DASHBOARd_MAIN_SETTING', 'DASHBOARd_MAIN_SETTING.DASHBOARD_MAIN_ID', '=', 'DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.DASHBOARD_SETTING_ID')
                    // ->where('DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.SETTING_USER_TYPE','=','DISTRIBUTOR')
                    // ->where(function($query) {
                    //     $query->where('DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.ACCESS_USER_DEPARTMENT', '=' , 1)
                    //     ->orWhere('DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.SUPER_USER_DEPARTMENT', '=' , 7);
                    // })
                    ...
                    ->where('DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.ACCESS_USER_DEPARTMENT', '=' , $request->ACCESS_USER_DEPARTMENT)
                    ->where('DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.ACCESS_USER_GROUP', '=' , $request->ACCESS_USER_GROUP)
                    ->where('DASHBOARD_DISTRIBUTOR_DISPLAY_SETTING.SETTING_USER_GROUP', '=' , 1)
                    ->orderBy('SETTING_INDEX', 'asc')
                    ->get();
    ...
    public function getChartSettingFourteen(Request $request)
    {
        try{
            $dist_id = DB::table('distributor_management.USER AS USER')
            ->select('USER.USER_DIST_ID AS USER_DIST_ID')
    ...
    public function getChartSettingTwelve(Request $request)
    {
        try{
