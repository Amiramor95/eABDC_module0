...
class TypeOfApplicationController extends Controller
{
    ...
    {
        try {
            $data = TypeOfApplication::find($request->TypeOfApplication_ID);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $data = TypeOfApplication::where('id',$id)->first();
    ...
    {
        try {
            $data = TypeOfApplication::find($id);
            $data->delete();
