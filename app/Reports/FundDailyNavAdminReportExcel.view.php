...
<div sheet-name="<?php echo $sheet1; ?>">
   ...
   foreach($datacon as $row)
   {
    ...
    $newArrayGlobal[] =  array( 
    'NO' => $row1['NO'],
    'FUNDNOTES DESCRIPTION' => $row1['FUNDNOTES_DESC'],
    'FUNDNOTES DENOTATION' => $row1['FUND_NOTES_DENOTATION'],
    );
    }
    $newMeta1= [];
    $ds1 = new \koolreport\core\DataStore($newArrayGlobal, $newMeta1);
    Table::create(array(
        "dataSource"=>$ds1,
        "complexHeaders" => true,
        "headerSeparator" => "-",
