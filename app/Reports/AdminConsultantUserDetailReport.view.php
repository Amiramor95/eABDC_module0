...
<html>
    ...
    <div class="text-right downloadlink">
        <!-- <a href="<?php //echo config('app.koolreport_server_url');?>/adminconuserdetailpdf?cuserid=<?php //echo $this->params["UID"]; ?>" style= margin-botom:10px;margin-right:5px;" class="btn btn-primary">Download Portrait PDF</a>
          <a href="<?php //echo config('app.koolreport_server_url');?>/adminconuserdetaillandscapepdf?cuserid=<?php //echo $this->params["UID"]; ?>" style="margin-botom:10px;margin-right:5px;" class="btn btn-primary">Download Landscape PDF</a> -->
          <a href="<?php echo config('app.koolreport_server_url');?>/adminconuserdetailexcel?cuserid=<?php echo $this->params["UID"]; ?>" style="margin-botom:10px;margin-right:5px;" class="btn btn-primary">Download EXCEL</a>
        </div>
