...
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    Report Name : CONSULTANTS REGISTRATION REPORT
    </div>
    ...
    //    foreach($dataapproval as $row3)
    //    {
    //        $newArrayApp[] = array(
    //                           'LATESTUPDATE' => date("d-M-Y", strtotime($row3['FIMM_LATEST_UPDATE'])),
    //                           'LATESTUPDATEBY' => $row3['FIMM_LATEST_UPDATE_BY'],
    //                           'TYPEID' => $row3['CONSULTANT_TYPE_ID'],
    //                           'CONSULTANTID' => $row3['CONSULTANT_ID'],
    //        );
    //    }
       $newArrayCon = array();
       $uts = "";
