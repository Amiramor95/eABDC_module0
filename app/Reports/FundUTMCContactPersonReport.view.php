...
<html>
    ...
    <div class="report-content">
        ...
        <div class="text-center">
            <h1>UTMC Contact Person Report</h1>
        </div>
        ...
        <!-- <div class="download_div">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/fundutmccontactpersonexcel">
        ...
        <div class="clear"></div>
    <?php
    $datacon = $this->dataStore('FUNDUTMCCONTACTREPORT');
    // echo "<pre>";
    // print_r($datacon);
    // echo "</pre>";
    $newArrayCon = array();
    foreach($datacon as $row)
    {
        ...
        // }
            ...
            $newArrayCon[] =  array( 
                                  ...
                                  'MOBILE NUMBER' => $row['USER_MOBILE_NUM'],
                                  'OFFICE NUMBER' => $row['USER_OFFICE_NUM'],
                             );
    }
    DataTables::create([
