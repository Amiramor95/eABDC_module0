...
<html>
    ...
    <div class="report-content"> 
        ...
        <!-- <div class="download_div">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/amsfsummaryutmciprpexcel">
            <?php
        ...
        <div class="clear"></div>
    <?php
    $datacon = $this->dataStore('AMSFSUMMARYUTMCIPRPREPORT');
        ...
        $membershiplevi = 50;
            $newArrayCon[] =  array( 
                                 // 'AMSF YEAR' => $row['AMSF_YEAR'],
                                  ...
                                  'MEMBERSHIP LEVY+IPRA ANNUAL FEES(UT+PRS)(RM)' => $membershiplevi+$row['ANNUALFEES'],
                                  ...
                                  'TOTAL PAYABLE(RM)' =>  $membershiplevi+$row['ANNUALFEES']+$row['TOTALUTCLEVY']+$row['UTCCARDFEE']+$row['TOTALPRCLEVY']+$row['PRCCARDFEE'],
                             );
    }
    ?>
    <div class="text-left">
                <h1>Summary Report Annual Membership Fees/Annual Fee Payment (UTMC-IPRA) Year <?php echo $this->params["AMSFYEAR"]; ?> - <?php echo $this->params["AMSFYEAREND"]; ?></h1>
            </div>
    <?php
    DataTables::create([
        ...
        "columns"=>array(
            ...
            "TOTAL NORMAL LOAD(PRS)(RM)"=>array(
                //"label"=>"UTS-EXAM PASSED",
                "type"=>"number",
                "decimals"=>2,
                "cssStyle"=>"dt-body-center",
            ...
            "TOTAL GROSS SALES(PRS)(RM)"=>array(
               // "label"=>"UTS-EXEMPTION",
                "type"=>"number",
                "decimals"=>2,
                "cssStyle"=>"text-align:center",
            ...
            "'MEMBERSHIP LEVY+IPRA ANNUAL FEES(UT+PRS)(RM)"=>array(
                //"label"=>"TOTAL",
                "type"=>"number",
                "decimals"=>2,
                "cssStyle"=>"text-align:center",
