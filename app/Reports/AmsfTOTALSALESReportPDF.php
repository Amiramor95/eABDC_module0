...
class AmsfTOTALSALESReportPDF extends \koolreport\KoolReport
{
    ...
    function setup()
    {
      ...
      $query_params2 = array();
        ...
        $this->src("mysql")
        ->query("Select FUND_SUBMISSION.FIMM_FUND_CODE AS FIMM_FUND_CODE,FUND_SUBMISSION.FUND_NAME AS FUND_NAME,FUND_SUBMISSION.CIS_STRUCTURE AS CIS_STRUCTURE,FUND_SUBMISSION.TGS_AMOUNT AS TGS_AMOUNT,DISTRIBUTOR.DIST_NAME AS DIST_NAME,DISTRIBUTOR.DISTRIBUTOR_ID AS DISTRIBUTOR_ID,DISTRIBUTOR.DIST_CODE AS DIST_CODE
       ...
       ")
        ->params($query_params)
        ->pipe($this->dataStore("AMSFTOTALSALESREPORT"));
