...
<html>
    ...
    <div class="report-content">
        ...
        <div class="text-center">
            <h1>FMS User Summary(FIMM) Report</h1>
        </div>
        ...
        <!-- <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/fundusersummaryfimmpdf">
            <?php
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/fundusersummaryfimmlandscapepdf">
            <?php
                foreach ($this->params['COMIDS'] as  $value) {
                ?>
                  <input type="hidden" name="COMIDS[]" value="<?php echo $value; ?>">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/fundusersummaryfimmexcel">
            <?php
                foreach ($this->params['COMIDS'] as  $value) {
                ?>
                  <input type="hidden" name="COMIDS[]" value="<?php echo $value; ?>">
        ...
        <div class="clear"></div>
    <?php
    $datacon = $this->dataStore('FUNDUSERSUMMARYFIMMREPORT');
    // echo "<pre>";
    // print_r($datacon);
    // echo "</pre>";
    $newArrayCon = array();
