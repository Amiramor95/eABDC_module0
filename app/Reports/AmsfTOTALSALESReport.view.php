...
<html>
    ...
    <div class="report-content"> 
        ...
        <!-- <div class="download_div">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/amsftotalsalesexcel">
            <?php
        ...
        <div class="clear"></div>
    <?php
    $datacon = $this->dataStore('AMSFTOTALSALESREPORT');
            ...
            $newArrayCon[] =  array( 
                                 // 'MEMBER CODE' => $row['DIST_CODE'],
                                  'COMPANY' => $row['DIST_NAME'],
                                   ...
                                   '3RD PARTY' => "",
                                   'SALES' => $row['TGS_AMOUNT'],
                             );
    }
    ?>
    <div class="text-left">
                <h1>Total AMSF for year <?php echo $this->params["AMSFYEAR"]; ?> to <?php echo $this->params["AMSFYEAREND"]; ?> (SALES)  </h1>
            </div>
    <?php
    DataTables::create([
