...
<html>
    ...
    <div class="text-right downloadlink">
        <!-- <a href="<?php //echo config('app.koolreport_server_url');?>/admindistuserdetailpdf?duserid=<?php //echo $this->params["UID"]; ?>" style= margin-botom:10px;margin-right:5px;" class="btn btn-primary">Download Portrait PDF</a>
          <a href="<?php //echo config('app.koolreport_server_url');?>/admindistuserdetaillandscapepdf?duserid=<?php //echo $this->params["UID"]; ?>" style="margin-botom:10px;margin-right:5px;" class="btn btn-primary">Download Landscape PDF</a> -->
          <a href="<?php echo config('app.koolreport_server_url');?>/admindistuserdetailexcel?duserid=<?php echo $this->params["UID"]; ?>" style="margin-botom:10px;margin-right:5px;" class="btn btn-primary">Download EXCEL</a>
        </div>
        <div style="height:20px;"></div>
        <div class="clear"></div>
    <?php
    $datadist = $this->dataStore('DISTRIBUTORUSERDETAIL');
