...
$datacon = $this->dataStore('AMSFD1FORMREPORT');
    $datadistributor = $this->dataStore('DISTRIBUTORLISTD1');
    $datatype = $this->dataStore('DISTRIBUTORTYPED1');
    $ryear = "";
    $newDate = "";
...
<html>
    ...
    <div class="report-content">
        ...
        <!-- <div class="download_div">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/amsfd1formdistributorexcel">
    ...
    ?>
        ...
        <hr style=" border: 1px solid #0a0a38;border-radius: 1px;"/>
        <div class="detail">We hereby declare the below information of the Total Gross Sales for <span>Private Retirement Schemes as at 31 December <?php echo $this->params["AMSFYEAR"]; ?></span> are complete, true and accurate.</div>
        <table class="table_form table">
        <tr>
        <td class="text-left">Total Normal Load :</td>
        <td class="text-left">RM <?php echo number_format((float)$totalnormal, 2, '.', ''); ?></td>
        </tr>
        <tr> 
        <td class="text-left">Total Low Load :</td>
        <td class="text-left">RM <?php echo number_format((float)$totallow, 2, '.', ''); ?></td>
        </tr>
        <tr> 
        <td class="text-left">Total No Load :</td>
        <td class="text-left">RM <?php echo number_format((float)$totalno, 2, '.', ''); ?></td>
        </tr>
        </table>
        <?php
    }
