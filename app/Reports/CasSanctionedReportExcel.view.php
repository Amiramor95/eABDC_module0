...
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    Report Name : The Total Number Of UTS/PRS Consultants Was Taken Action By FIMM Based On Distributors.
    </div>
    ...
    <div cell="A5">
      ...
      // $mapYear[$v['year']] = $v['total'];
       $newArray[] = array('NAME' => $v['DIST_NAME'],'YEAR' => $v['year'],'TOTAL' => $v['total']);
    //   }else{
       //$mapYear[$v['year']] = $v['total'];
      // }
     //  $newArray[$v['DISTRIBUTOR_ID']] = array('NAME' => $v['DIST_NAME'],'YEAR' => $v['year'],'TOTAL' => $v['total']);
       //$newArray[$v['DISTRIBUTOR_ID']][$v['year']] = $v['total'];//array($mapYear);
       }
