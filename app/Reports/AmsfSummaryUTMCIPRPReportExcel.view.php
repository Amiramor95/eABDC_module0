...
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    Report Name : Summary Report Annual Membership Fees/Annual Fee Payment (UTMC-IPRA) Year <?php echo $this->params["AMSFYEAR"]; ?> - <?php echo $this->params["AMSFYEAREND"]; ?>(IUTA)
    </div>
