...
class AmsfD2FormDistributorReportPDF extends \koolreport\KoolReport
{
    ...
    function setup()
    {
      ...
      $query_params2 = array();
        ...
        $this->src("mysql")
        ->query("Select FUND_SUBMISSION.FUND_NAME AS FUND_NAME,FUND_SUBMISSION.FUND_GROUP AS FUND_GROUP,FUND_SUBMISSION.TGS_AMOUNT AS TGS_AMOUNT,AUM_ENTRY.AUM_REMARKS_MANAGER AS AUM_REMARKS_MANAGER,FMS_FUNDCATEGORY.GROUP_ASSET AS GROUP_ASSET
        ...
        ")
        ->params($query_params)
        ->pipe($this->dataStore("AMSFD2FORMREPORT"));
        ...
        ->pipe($this->dataStore("DISTRIBUTORLISTD2"));
        $this->src("mysql")
        ...
        ->pipe($this->dataStore("DISTRIBUTORTYPED2"));
