...
<html>
    ...
    <div class="report-content"> 
        ...
        <!-- <div class="download_div">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/amsftotalaumexcel">
            <?php
        ...
        <div class="clear"></div>
    <?php
    $datacon = $this->dataStore('AMSFTOTALAUMREPORT');
   // $datatype = $this->dataStore('DISTRIBUTORTYPE');
    ...
    foreach($datacon as $row)
    {
        ...
        $shasridate = "";
            ...
            $newArrayCon[] =  array( 
                                  'MEMBER CODE' => $row['DIST_CODE'],
                                  'COMPANY' => $row['DIST_NAME'],
                                   'FUND CODE' => $row['FIMM_FUND_CODE'],
                                   'FUND NAME' => $row['FUND_NAME'],
                                   'FUND SHORT NAME' => $row['FUND_NAME_SHORT'],
                                   'FCIS STRUCTURE' => $row['CIS_STRUCTURE'],
                                   'AUM' => $row['AUM_AMOUNT'],
                             );
    }
    ?>
    <div class="text-left">
                <h1>Total AMSF for year <?php echo $this->params["AMSFYEAR"]; ?> to <?php echo $this->params["AMSFYEAREND"]; ?> (AUM)  </h1>
            </div>
    <?php
    DataTables::create([
        ...
        "columns"=>array(
            ...
            "FUND SHORT NAME"=>array(
                //"label"=>"TOTAL",
                "type"=>"string",
                "searchable" => true,
            ),
             "FCIS STRUCTURE"=>array(
                // "label"=>"PRS-VARIATION",
                "type"=>"string",
                "searchable" => true,
                 "footerText"=>"<b>TOTAL</b>",
