...
<html>
    ...
    <div class="report-content">
        ...
        <div class="form-group">
            ...
            <b>FUND STATUS</b>
                ...
                Select2::create(array(
                    ...
                    "name"=>"TSIDS",
                    "defaultOption"=>array("All"=>0),
                    "dataSource"=>$this->dataStore("FUNDSTATUSLIST"),
                    "dataBind"=>array(
                                "text"=>"TS_PARAM",
                                "value"=>"TSID",
                            ),
        ...
        <!-- <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/funddatastatuspdf">
            <?php
                ...
                ?>
                <?php
                foreach ($this->params['TSIDS'] as  $value1) {
                ?>
                  <input type="hidden" name="TSIDS[]" value="<?php echo $value1; ?>">
                <?php
                }
                ?>
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/funddatastatuslandscapepdf">
            <?php
                foreach ($this->params['DISTRIBUTORIDS'] as  $value) {
                ?>
                  <input type="hidden" name="DISTRIBUTORIDS[]" value="<?php echo $value; ?>">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/funddatastatusexcel">
            <?php
                foreach ($this->params['DISTRIBUTORIDS'] as  $value) {
                ?>
                  <input type="hidden" name="DISTRIBUTORIDS[]" value="<?php echo $value; ?>">
        ...
        <div class="clear"></div>
    <?php
    $datacon = $this->dataStore('FUNDDATASTATUSREPORT');
    $newArrayCon = array();
           ...
           $suspendeddate = date("d-M-Y", strtotime($row['FUND_SUSPENSION_DATE']));
            ...
            $newArrayCon[] =  array( 
                                 // 'ID' => $row['DISTRIBUTOR_ID'],
                                  ...
                                  'MATURITY/CLOSURE DATE' => $updatedate,
