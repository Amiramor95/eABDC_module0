...
<html>
    ...
    <div class="report-content"> 
        ...
        <!-- <div class="download_div">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/amsfaumexcel">
            <?php
    ...
    ?>
    <div class="text-left">
            <h1>AMSF AUM for year <?php echo $this->params["AMSFYEAR"]; ?> - <?php echo $this->params["AMSFYEAREND"]; ?> Report</h1>
        </div>
    <?php
    DataTables::create([
