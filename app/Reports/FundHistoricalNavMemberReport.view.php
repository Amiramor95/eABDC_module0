...
<html>
    ...
    <div class="report-content">
        ...
        <!-- <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/fundhistoricalnavmemberpdf">
            <?php
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/fundhistoricalnavmemberlandscapepdf">
            <?php
                foreach ($this->params['DISTRIBUTORIDS'] as  $value) {
                ?>
                  <input type="hidden" name="DISTRIBUTORIDS[]" value="<?php echo $value; ?>">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/fundhistoricalnavmemberexcel">
            <?php
                foreach ($this->params['DISTRIBUTORIDS'] as  $value) {
                ?>
                  <input type="hidden" name="DISTRIBUTORIDS[]" value="<?php echo $value; ?>">
        ...
        <div class="clear"></div>
    <?php
    $datacon = $this->dataStore('FUNDHISTORICALNAVMEMBEREPORT');
           ...
           $updatedate = date("d-M-Y", strtotime($row['NAV_SUBMIT_TIMESTAMP'])); 
            ...
            $newArrayCon[] =  array( 
                                 // 'ID' => $row['DISTRIBUTOR_ID'],
                                  ...
                                  'MEMBER FUND CODE' =>  $row['FUND_CODE_MEMBER'],
                                  'SUBMISSION DATE' => $updatedate,
