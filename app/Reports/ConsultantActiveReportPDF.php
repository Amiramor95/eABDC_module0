...
class ConsultantActiveReportPDF extends \koolreport\KoolReport
{
    ...
    //   }
        $this->src("mysql")
        ->query("Select CONSULTANT.CONSULTANT_ID AS CID,CONSULTANT.CONSULTANT_NAME AS CNAME,CONSULTANT.CONSULTANT_NRIC AS NRIC,CONSULTANT.CONSULTANT_FIMM_NO AS FIMMNO,CONSULTANT_LICENSE.CONSULTANT_TYPE_ID AS TYPEID,CONSULTANT_LICENSE.CMSRL_NO AS CMSRL_NO,CONSULTANT_LICENSE.CMSRL AS CMSRL,CONSULTANT_LICENSE.CMSRL_EXPIRE_DATE AS CMSRL_EXPIRE_DATE,CONSULTANT_CPD.CPD_POINT AS CPD_POINT,CONSULTANT_APPROVAL.CREATE_TIMESTAMP AS REGDATE
        ...
        LEFT JOIN cpd_management.CONSULTANT_CPD AS CONSULTANT_CPD
        ON CONSULTANT_CPD.CONSULTANT_ID = CONSULTANT.CONSULTANT_ID
        LEFT JOIN consultant_management.CONSULTANT_APPROVAL AS CONSULTANT_APPROVAL
        ON CONSULTANT_APPROVAL.CONSULTANT_ID = CONSULTANT_LICENSE.CONSULTANT_ID
