...
class AmsfSummaryIUTAReportPDF extends \koolreport\KoolReport
{
    ...
    function setup()
    {
      ...
      $query_params2 = array();
        ...
        $this->src("mysql")
        ->query("Select SUM(FUND_SUMMARY.TOTAL_NORMAL) AS TOTALGROUPA,SUM(FUND_SUMMARY.TOTAL_LOW) AS TOTALGROUPB,SUM(FUND_SUMMARY.TOTAL_NO) AS TOTALGROUPC,SUM(FUND_SUMMARY.ANNUAL_FEES) AS ANNUALFEE,SUM(FUND_SUMMARY.TOTAL_UTC_LEVY) AS TOTALUTCLEVY,SUM(FUND_SUMMARY.TOTAL_UTC) AS TOTALUTC,DISTRIBUTOR.DIST_NAME AS DIST_NAME
        ...
        WHERE DISTRIBUTOR_TYPE.DIST_TYPE = 3
        ...
        ->params($query_params)
        ->pipe($this->dataStore("AMSFSUMMARYIUTAREPORT"));
