...
<div sheet-name="<?php echo $sheet1; ?>">
    ...
    ?>
    <div cell="A1" range="A1:J1" excelstyle='<?php echo json_encode($styleArray); ?>' >Report Name : SALUTATION LISTING REPORT
    </div>
    ...
    <div cell="A5"> 
      <?php
        $data_queryB = $this->dataStore('SALUTATIONLIST');
        $newArray = array();
        foreach($data_queryB as $row)
        {
                $newArray[] =  array(
                                     'SALUTATIONNAME' => $row['SALUTATIONNAME'],
                                     'DATE' => $row['DATE'],
                                     'USER' => $row['USER'],
                                 );
        }
