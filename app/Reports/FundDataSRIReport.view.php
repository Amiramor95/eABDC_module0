...
<html>
    ...
    <div class="report-content">
        ...
        <div class="text-center">
            <h1>Fund Data - SRI/ESG & Shariah Funds</h1>
        </div>
        ...
        <!-- <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/funddataSRIpdf">
            <?php
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/funddataSRIlandscapepdf">
            <?php
                foreach ($this->params['DISTRIBUTORIDS'] as  $value) {
                ?>
                  <input type="hidden" name="DISTRIBUTORIDS[]" value="<?php echo $value; ?>">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/funddataSRIexcel">
            <?php
                foreach ($this->params['DISTRIBUTORIDS'] as  $value) {
                ?>
                  <input type="hidden" name="DISTRIBUTORIDS[]" value="<?php echo $value; ?>">
        ...
        <div class="clear"></div>
    <?php
    $datacon = $this->dataStore('FUNDDATASRIREPORT');
    $newArrayCon = array();
    foreach($datacon as $row)
    {
        ...
        {
           $shasridate = date("d-M-Y", strtotime($row['FUND_DATE_SRI_ESG_EFFECTIVE_DATE']));
        }
            ...
            $newArrayCon[] =  array( 
                                 // 'ID' => $row['DISTRIBUTOR_ID'],
                                  ...
                                  'SRI/ESG FUND' => $row['FUND_SRI_ESG'],
                                  'SRI/ESG EFFECTIVE DATE' => $shasridate,
                                  'SHARIAH COMPLAINT' => $row['FUND_SYARIAH_COMP'],
                             );
    }
    DataTables::create([
