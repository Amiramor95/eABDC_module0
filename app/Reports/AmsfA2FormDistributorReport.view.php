...
<html>
    ...
    <div class="report-content">
        ...
        <!-- <div class="download_div">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/amsfa2formdistributorexcel">
        ...
        <div class="clear"></div>
    <?php
    $datacon = $this->dataStore('AMSFA2FORMREPORT');
    ...
    echo "<pre>";
    print_r($newArrayDept);
    echo "</pre>";
    if(in_array($this->params["DID"], $newArrayDept))
    {
        echo "True";
    }
