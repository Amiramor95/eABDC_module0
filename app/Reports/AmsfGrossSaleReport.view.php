...
<html>
    ...
    <div class="report-content"> 
        ...
        <div class="form-group">
            ...
            <b>SCHEME STRUCTURE</b>
                <?php
                $scheme = array();
                $scheme[0] = array('SCHEMENAME' => 'UTF');
                $scheme[1] = array('SCHEMENAME' => 'PRS');
                $scheme[2] = array('SCHEMENAME' => 'ETF');
                Select2::create(array(
                    "multiple"=>false,
                    "name"=>"SCHEMENAME",
                    "defaultOption"=>array("All"=>0),
        ...
        <!-- <div class="download_div">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/amsfgrosssaleexcel">
            <?php
                ...
                ?>
                 <input type="hidden" value="<?php echo $this->params["SCHEMENAME"]; ?>" name="SCHEMENAME" />
        ...
        <div class="clear"></div>
    <?php
    $datacon = $this->dataStore('AMSFGROSSSALEREPORT');
    // echo "<pre>";
    // print_r($datacon);
    // echo "</pre>";
    $newArrayCon = array();
    ...
    ?>
    <div class="text-left">
            <h1>AMSF GROSS SALES FOR YEAR <?php echo $this->params["AMSFYEAR"]; ?> - <?php echo $this->params["AMSFYEAREND"]; ?> REPORT</h1>
        </div>
    <?php
    DataTables::create([
