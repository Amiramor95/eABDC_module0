...
class FundHistoricalNavDetailReportPDF extends \koolreport\KoolReport
{
    ...
    function setup()
    {
      ...
      $query_params2 = array();
        ...
        $this->src("mysql")
        ->query("Select DISTRIBUTOR.DIST_NAME AS DIST_NAME,FUND_PROFILE.FUND_NAME AS FUND_NAME,FUND_PROFILE.FUND_CODE_FIMM AS FUND_CODE_FIMM,NAV_LIST.CREATE_TIMESTAMP AS CREATE_TIMESTAMP,NAV_LIST.NAV_SUBMIT_TIMESTAMP AS NAV_SUBMIT_TIMESTAMP,NAV_LIST.NAV_VAL AS NAV_VAL,SETTING_GENERAL.SET_PARAM AS FUND_CURR_DENOMINATION,DISTRIBUTOR.DISTRIBUTOR_ID AS DISTRIBUTOR_ID
        ...
        ->params($query_params)
        ->pipe($this->dataStore("FUNDHISTORICALNAVDETAILREPORT"));
