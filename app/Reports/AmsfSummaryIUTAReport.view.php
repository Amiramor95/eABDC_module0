...
<html>
    ...
    <div class="report-content"> 
        ...
        <!-- <div class="download_div">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/amsfsummaryiutaexcel">
            <?php
    ...
    ?>
    <div class="text-left">
                <h1>SUMMARY REPORT UTF SUBSCRIPTION FEES FOR YEAR <?php echo $this->params["AMSFYEAR"]; ?> - <?php echo $this->params["AMSFYEAREND"]; ?>(IUTA)</h1>
            </div>
    <?php
    DataTables::create([
