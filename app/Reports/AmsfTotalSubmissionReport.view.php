...
<html>
    ...
    <div class="report-content"> 
        ...
        <!-- <div class="download_div">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/amsftotalsubmissionexcel">
            <?php
        ...
        // }
            ...
            $newArrayCon[] =  array( 
                                 // 'AMSF YEAR' => $row['AMSF_YEAR'],
                                  ...
                                  'TOTAL UTC' => $row['TOTALUTS'],
                                  'TOTAL PRC' => $row['TOTALPRS'],
                                  'COMBINE UTC & PRC' => $row['TOTALUTSPRS'],
                                  'SPLIT UTC' => $row['SPLITUTS'],
                                  'SPLIT PRC' => $row['SPLITPRS'],
                                  'TOTAL WAIVER' => $row['TOTALWAIVER'],
                                  'TOTAL' => $row['TOTALUTS']+$row['TOTALPRS']+$row['TOTALUTSPRS']+$row['SPLITUTS']+$row['SPLITPRS']+$row['TOTALWAIVER'],
                             );
    }
    ?>
    <div class="text-left">
            <h1>TOTAL SUBMISSION FOR YEAR <?php echo $this->params["AMSFYEAR"]; ?> - <?php echo $this->params["AMSFYEAREND"]; ?> REPORT</h1>
        </div>
    <?php
    DataTables::create([
