...
<html>
    ...
    <div class="text-right downloadlink">
        <!-- <a href="<?php echo config('app.koolreport_server_url');?>/adminotheruserdetailpdf?ouserid=<?php echo $this->params["UID"]; ?>" style= margin-botom:10px;margin-right:5px;" class="btn btn-primary">Download Portrait PDF</a>
          <a href="<?php echo config('app.koolreport_server_url');?>/adminotheruserdetaillandscapepdf?ouserid=<?php echo $this->params["UID"]; ?>" style="margin-botom:10px;margin-right:5px;" class="btn btn-primary">Download Landscape PDF</a> -->
          <a href="<?php echo config('app.koolreport_server_url');?>/adminotheruserdetailexcel?ouserid=<?php echo $this->params["UID"]; ?>" style="margin-botom:10px;margin-right:5px;" class="btn btn-primary">Download EXCEL</a>
        </div>
        <div style="height:20px;"></div>
        <div class="clear"></div>
    <?php
    $datafimm = $this->dataStore('OTHERUSERDETAIL');
      ...
      else if($row['UTYPE'] == 3)
      {
        ...
        ?>
            ...
            <tr class="odd" role="row">
                ...
                <tr class="even" role="row">
                    <td class="row_title">USER TYPE</td>
                    <td class="sorting_1">
                    <?php echo $type; ?>
                    </td>
                </tr>
