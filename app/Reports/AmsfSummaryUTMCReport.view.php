...
<html>
    ...
    <div class="report-content"> 
        ...
        <!-- <div class="download_div">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/amsfsummaryutmcexcel">
            <?php
        ...
        <div class="clear"></div>
    <?php
    $datacon = $this->dataStore('AMSFSUMMARYUTMCREPORT');
    // echo "<pre>";
    // print_r($datacon);
    // echo "</pre>";
    $newArrayCon = array();
...
?>
<div class="text-left">
            <h1>SUMMARY REPORT UTF SUBSCRIPTION FEES FOR YEAR <?php echo $this->params["AMSFYEAR"]; ?> - <?php echo $this->params["AMSFYEAREND"]; ?>(UTMC)</h1>
        </div>
<?php
    DataTables::create([
