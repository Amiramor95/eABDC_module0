...
<html>
    ...
    <div class="report-content">
        ...
        <div class="form-group">
            ...
            <b>FUND CATEGORY</b>
                ...
                Select2::create(array(
                    ...
                    "name"=>"CATEGORYIDS",
                    "defaultOption"=>array("All"=>0),
                    "dataSource"=>$this->dataStore("FUNDCATEGORYLIST"),
                    "dataBind"=>array(
                                "text"=>"GROUP_ASSET",
                                "value"=>"CATEGORYID",
                            ),
            ...
            <b>SCHEME STRUCTURE</b>
                ...
                Select2::create(array(
                    ...
                    "name"=>"SCHEMEIDS",
                    "defaultOption"=>array("All"=>0),
                    "dataSource"=>$this->dataStore("FUNDSCHEMELIST"),
                    "dataBind"=>array(
                                "text"=>"FMS_SCHEME_NAME",
                                "value"=>"SCHEMEID",
                            ),
                    // "clientEvents"=>array(
                    //     "change"=>"function(e){
            ...
            <div class="form-group">
                ...
                <?php 
                 $types = array();
                 $types[0] = array('TYPENAME' => 'YES','ID' => 1);
                 $types[1] = array('TYPENAME' => 'NO','ID' => 2);
        ...
        <!-- <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/funddatanewpdf">
            <?php
                ...
                ?>
                <?php
                foreach ($this->params['CATEGORYIDS'] as  $value1) {
                ?>
                  <input type="hidden" name="CATEGORYIDS[]" value="<?php echo $value1; ?>">
                <?php
                }
                ?>
                 <?php
                foreach ($this->params['SCHEMEIDS'] as  $value2) {
                ?>
                  <input type="hidden" name="SCHEMEIDS[]" value="<?php echo $value2; ?>">
                <?php
                }
                ?>
                 <?php
                foreach ($this->params['SHARIAH'] as  $value3) {
                ?>
                  <input type="hidden" name="SHARIAH[]" value="<?php echo $value3; ?>">
                <?php
                }
                ?>
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/funddatanewlandscapepdf">
            <?php
                foreach ($this->params['DISTRIBUTORIDS'] as  $value) {
                ?>
                  <input type="hidden" name="DISTRIBUTORIDS[]" value="<?php echo $value; ?>">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/funddatanewexcel">
            <?php
                foreach ($this->params['DISTRIBUTORIDS'] as  $value) {
                ?>
                  <input type="hidden" name="DISTRIBUTORIDS[]" value="<?php echo $value; ?>">
        ...
        <div class="clear"></div>
    <?php
    $datacon = $this->dataStore('FUNDDATANEWREPORT');
        ...
        // }
            $newArrayCon[] =  array( 
                                 // 'ID' => $row['DISTRIBUTOR_ID'],
                                  ...
                                  'FUND TYPE' =>  $row['FUND_TYPE'],
                                  'FUND CATEGORY' => $row['FUNDCATEGORY'],
                                  'SHARIAH' =>  $shasri,
                                  'SCHEME STRUCTURE' => $row['FUND_SCHEME'],
                                  'UNITS STRUCTURE' => $row['FUND_UNIT_STRUCTURE'],
                                  'INVESTMENT FOCUS' => $row['FUND_INVESTMENT_FOCUS'],
                                  'FEEDER FUND' => $row['FUND_FEEDER'],
                                  'FOE' => $row['FUND_FOF'],
                             );
    }
    DataTables::create([
