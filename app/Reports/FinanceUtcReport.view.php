...
<html>
    ...
    <div class="report-content">
        ...
        <div class="text-center">
            <h1>UTC Batch Details Report</h1>
        </div>
        <div class="clear"></div>
        <form method="post">
...
<?php
//if($this->dataStore("FINANCEUTCREPORT")->countData()>0)
//{
    ?>
    ...
    <div class="report_title">Report Name: UTC Batch Details Report </div>
    ...
    <div class="text-right downloadlink">
        <!-- <a href="<?php echo config('app.koolreport_server_url');?>/financeutcpdf" style= margin-botom:10px;margin-right:5px;" class="btn btn-primary">Download Portrait PDF</a>
          ...
          <form method="post" action="<?php echo config('app.koolreport_server_url');?>/financeutcexcel">
