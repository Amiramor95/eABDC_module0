...
class AmsfD1FormDistributorReportPDF extends \koolreport\KoolReport
{
    ...
    function setup()
    {
      ...
      $query_params2 = array();
        ...
        ")
        ->params($query_params)
        ->pipe($this->dataStore("AMSFD1FORMREPORT"));
        ...
        ->pipe($this->dataStore("DISTRIBUTORLISTD1"));
        $this->src("mysql")
        ...
        ->pipe($this->dataStore("DISTRIBUTORTYPED1"));
