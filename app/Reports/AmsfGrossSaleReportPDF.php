...
class AmsfGrossSaleReportPDF extends \koolreport\KoolReport
{
    ...
    function setup()
    {
      ...
      $query_params2 = array();
        ...
        from annualFee_management.TGS_ENTRY AS TGS_ENTRY
        LEFT JOIN annualFee_management.FUND_SUBMISSION AS FUND_SUBMISSION
        ON FUND_SUBMISSION.FUND_SUBMISSION_ID = TGS_ENTRY.FUND_SUBMISSION_ID
        ...
        ".(( $this->params["AMSFYEAREND"]?"and FUND_SUBMISSION.AMSF_YEAR <= :end":""))." 
         ")
        ->params($query_params)
        ->pipe($this->dataStore("AMSFGROSSSALEREPORT"));
