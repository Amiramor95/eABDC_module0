...
<html>
    ...
    <div class="report-content">
        ...
        <!-- <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/fundeventlogpdf">
            <?php
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/fundeventloglandscapepdf">
            <?php
                foreach ($this->params['DISTRIBUTORIDS'] as  $value) {
                ?>
                  <input type="hidden" name="DISTRIBUTORIDS[]" value="<?php echo $value; ?>">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/fundeventlogexcel">
            <?php
                foreach ($this->params['DISTRIBUTORIDS'] as  $value) {
                ?>
                  <input type="hidden" name="DISTRIBUTORIDS[]" value="<?php echo $value; ?>">
        ...
        <div class="clear"></div>
    <?php
    $datacon = $this->dataStore('FUNDEVENTLOGREPORT');
    // echo "<pre>";
    // print_r($datacon);
    // echo "</pre>";
    $newArrayCon = array();
    foreach($datacon as $row)
    {
        ...
        // if($row['CREATED_AT'] != '')
        // {
        //    $updatedate = date("d-M-Y", strtotime($row['CREATED_AT']));
        // }
       
       // $decoded_json = json_decode($row['DETAIL'], false);
            $newArrayCon[] =  array(  
