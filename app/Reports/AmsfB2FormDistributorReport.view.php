...
$datacon = $this->dataStore('AMSFB2FORMREPORT');
$datadistributor = $this->dataStore('DISTRIBUTORLIST');
$datatype = $this->dataStore('DISTRIBUTORTYPEB2');
$ryear = "";
$newDate = "";
...
<html>
    ...
    <div class="report-content">
        ...
        <!-- <div class="download_div">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/amsfb2formdistributorexcel">
