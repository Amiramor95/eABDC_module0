...
<html>
    ...
    <div class="report-content"> 
        ...
        <!-- <div class="download_div">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/amsfsummarycutacpraexcel">
            <?php
    ...
    ?>
    <div class="text-left">
                <h1>Summary Report Annual Membership Fees/Annual Fee Payment (CUTA/CPRA) Year  <?php echo $this->params["AMSFYEAR"]; ?> - <?php echo $this->params["AMSFYEAREND"]; ?></h1>
            </div>
    <?php
    DataTables::create([
