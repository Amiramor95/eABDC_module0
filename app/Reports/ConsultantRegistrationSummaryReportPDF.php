...
class ConsultantRegistrationSummaryReportPDF extends \koolreport\KoolReport
{
    ...
    if($this->params["DISTRIBUTORIDS"] != array(0) )
    {
        ...
        $this->src("mysql")
        ->query("Select CONSULTANT.CONSULTANT_ID AS CONSULTANT_ID,CONSULTANT.CONSULTANT_APPLICATION_TYPE AS CONSULTANTAPPLICATIONTYPE,CONSULTANT_LICENSE.DISTRIBUTOR_ID AS DISTRIBUTOR_ID,CONSULTANT_LICENSE.CONSULTANT_TYPE_ID AS CONSULTANT_TYPE_ID,CONSULTANT_EXAM.EXAM_RESULT_STATUS AS EXAM_RESULT_STATUS
        ...
        LEFT JOIN consultant_management.CONSULTANT_EXAM AS CONSULTANT_EXAM
        ON CONSULTANT_EXAM.CONSULTANT_LICENSE_ID = CONSULTANT_LICENSE.CONSULTANT_LICENSE_ID
        WHERE 1 = 1
         ")
        ->pipe($this->dataStore("CONSULTANTEXAMREPORT"));
