...
$datacon = $this->dataStore('AMSFC1FORMREPORT');
$datadistributor = $this->dataStore('DISTRIBUTORLISTC1');
$datatype = $this->dataStore('DISTRIBUTORTYPEC1');
$ryear = "";
$newDate = "";
...
<html>
    ...
    <div class="report-content">
        ...
        <!-- <div class="download_div">
         ...
         <div class="download_div">
            <form method="post" action="<?php echo config('app.koolreport_server_url');?>/amsfc1formdistributorexcel">
   ...
   { 
    ...
    ?>
        ...
        <hr style=" border: 1px solid #0a0a38;border-radius: 1px;"/>
        <div class="detail">We hereby declare the below information of the Asset Under Management(AUM) for <span>Private Retirement Schemes as at 31 December <?php echo $this->params["AMSFYEAR"]; ?></span> are complete, true and accurate.</div>
        <?php
    }
    ?>
