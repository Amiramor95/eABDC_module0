...
class CreateDASHBOARDCPDDISPLAYSETTINGTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('DASHBOARD_CPD_DISPLAY_SETTING', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('DASHBOARD_CPD_DISPLAY_SETTING');
    }
}
