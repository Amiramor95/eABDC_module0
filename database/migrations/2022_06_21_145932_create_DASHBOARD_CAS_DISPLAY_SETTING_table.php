...
class CreateDASHBOARDCASDISPLAYSETTINGTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('DASHBOARD_CAS_DISPLAY_SETTING', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('DASHBOARD_CAS_DISPLAY_SETTING');
    }
}
