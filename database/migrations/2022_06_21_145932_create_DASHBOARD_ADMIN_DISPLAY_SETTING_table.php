...
class CreateDASHBOARDADMINDISPLAYSETTINGTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('DASHBOARD_ADMIN_DISPLAY_SETTING', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('DASHBOARD_ADMIN_DISPLAY_SETTING');
    }
}
