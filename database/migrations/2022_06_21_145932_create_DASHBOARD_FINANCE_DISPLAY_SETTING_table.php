...
class CreateDASHBOARDFINANCEDISPLAYSETTINGTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('DASHBOARD_FINANCE_DISPLAY_SETTING', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('DASHBOARD_FINANCE_DISPLAY_SETTING');
    }
}
