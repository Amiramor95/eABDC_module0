...
class CreateDASHBOARDANNUALDISPLAYSETTINGTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('DASHBOARD_ANNUAL_DISPLAY_SETTING', function (Blueprint $table) {
            ...
            $table->integer('SETTING_USER_TYPE_GROUP')->default(0);
    ...
    {
        Schema::dropIfExists('DASHBOARD_ANNUAL_DISPLAY_SETTING');
    }
}
