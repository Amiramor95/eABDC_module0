...
class CreateDASHBOARDFMSDISPLAYSETTINGTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('DASHBOARD_FMS_DISPLAY_SETTING', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('DASHBOARD_FMS_DISPLAY_SETTING');
    }
}
